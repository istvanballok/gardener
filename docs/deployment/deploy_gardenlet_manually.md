...
- Every seed cluster needs an Ingress controller which distributes external requests to internal components like Plutono and Prometheus. Gardener supports two approaches to achieve this:
