...
var _ = Describe("Replica", func() {
	...
	var (
		...
		seed = func(deletionTimestamp *metav1.Time, gardenletReady, backupBucketsReady, seedSystemComponentsHealthy, seedObservabilityComponentsHealthy bool) *gardencorev1beta1.Seed {
			var conditions []gardencorev1beta1.Condition
			if gardenletReady {
				conditions = append(conditions, gardencorev1beta1.Condition{
			...
			if seedObservabilityComponentsHealthy {
				conditions = append(conditions, gardencorev1beta1.Condition{
	...
	DescribeTable("#IsSeedReady",
		...
		Entry("should return true", seed(nil, true, false, true, false), false),
		Entry("should return true", seed(nil, true, true, true, false), false),
		Entry("should return false", seed(nil, true, true, false, false), false),
		Entry("should return false", seed(nil, false, false, false, true), false),
		Entry("should return true", seed(nil, true, false, true, true), true),
		Entry("should return true", seed(nil, true, true, true, true), true),
		Entry("should return false", seed(nil, true, true, false, true), false),
		Entry("should return false", seed(&now, true, true, true, true), false),
		Entry("should return false", seed(&now, true, true, true, false), false),
	)
