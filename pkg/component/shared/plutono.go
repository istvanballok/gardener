...
func NewPlutono(
	...
	isGardenCluster, vpnHighAvailabilityEnabled, vpaRecommendationsAvailable, vpaInternalsAvailable bool,
	...
	return plutono.New(
		...
		plutono.Values{
			...
			VPARecommendationsAvailable: vpaRecommendationsAvailable,
			VPAInternalsAvailable:       vpaInternalsAvailable,
